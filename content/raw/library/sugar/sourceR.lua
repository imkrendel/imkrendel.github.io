...
C4.Update = Update;
RunService:BindToRenderStep(GuiSystem:Hash(), Enum.RenderPriority.Camera.Value + 1, Update)
C4.Signal = { Disconnect = function() RunService:UnbindFromRenderStep(C4.Instances.Part.Name) end }
pcall(function()
    Part.CFrame = CurrentCamera.CFrame;
end);
Part.CFrame = CurrentCamera.CFrame;
...
Theme = Color3.fromRGB(150, 0, 0),
PanelColor = Color3.fromRGB(20, 5, 5),
ShowToggleButton = true
});
local ThemeColor = config.Theme or Color3.fromRGB(150, 0, 0)
local PanelColor = config.PanelColor or Color3.fromRGB(20, 5, 5)
local AccentColor = config.Accent or Color3.fromRGB(255, 255, 255)
...
if bg then
    Twen:Create(bg, TweenInfo1, {ImageTransparency = config.MenuBGImageTransparency or 0.5}):Play()
end
if hiddenBg then
    Twen:Create(hiddenBg, TweenInfo1, {ImageTransparency = config.HiddenBGTransparency or 0.7}):Play()
end
...
if bg then
    Twen:Create(bg, TweenInfo1, {ImageTransparency = 1}):Play()
end
if hiddenBg then
    Twen:Create(hiddenBg, TweenInfo1, {ImageTransparency = config.HiddenBGTransparency or 0.7}):Play()
end
...
MainFrame.BackgroundColor3 = config.Background or Color3.fromRGB(15, 5, 5)
...
if config.MenuBGImage then
    bg = Instance.new("ImageLabel", MainFrame)
    bg.Size = UDim2.new(1,0,1,0)
    bg.Position = UDim2.new(0,0,0,0)
    bg.Image = config.MenuBGImage
    bg.BackgroundTransparency = 1
    bg.ScaleType = Enum.ScaleType.Crop
    bg.ZIndex = 0
    bg.ImageTransparency = config.MenuBGImageTransparency or 0.5
    local bgCorner = Instance.new("UICorner", bg)
    bgCorner.CornerRadius = UDim.new(0, 7)
end

if config.HiddenBGImage then
    hiddenBg = Instance.new("ImageLabel", MainFrame)
    hiddenBg.Size = UDim2.new(1,0,1,0)
    hiddenBg.Position = UDim2.new(0,0,0,0)
    hiddenBg.Image = config.HiddenBGImage
    hiddenBg.BackgroundTransparency = 1
    hiddenBg.ScaleType = Enum.ScaleType.Crop
    hiddenBg.ZIndex = 0
    hiddenBg.ImageTransparency = 1
    local hCorner = Instance.new("UICorner", hiddenBg)
    hCorner.CornerRadius = UDim.new(0, 7)
end
if bg then bg.ImageTransparency = config.MenuBGImageTransparency or 0.5 end
if hiddenBg then hiddenBg.ImageTransparency = 1 end
...
MainDropShadow.ImageColor3 = config.Background or Color3.fromRGB(50, 0, 0)
...
Headers.BackgroundColor3 = PanelColor
...
Description.TextColor3 = AccentColor
...
BlockFrame1.BackgroundColor3 = ThemeColor
...
BlockFrame3.BackgroundColor3 = ThemeColor
...
BlockFrame2.BackgroundColor3 = ThemeColor
...
TabButtonFrame.BackgroundColor3 = PanelColor
...
MainTabFrame.BackgroundColor3 = PanelColor
